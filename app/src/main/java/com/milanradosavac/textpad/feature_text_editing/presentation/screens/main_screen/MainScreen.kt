    ...
    Column {
        ...
        Box {
            ...
            Row(
                ...
                Button(onClick = {  }) {
                    Text(text = stringResource(id = R.string.open), style = MaterialTheme.typography.body1)
                }
                Button(onClick = {  }) {
                    Text(text = stringResource(id = R.string.close), style = MaterialTheme.typography.body1)
                }
                Button(onClick = {  }) {
